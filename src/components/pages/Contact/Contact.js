  ...
  return (
    <div>
      ...
      <form className='form' onSubmit={(e) => submitForm(e)}>
              ...
              <FormElement label={{ for: "surname", text: "Nom" }} input={{className:"width-formInpt_noFlex", type: "text", name: "surname", id: "surname",required:true,value:formInputs.surname, onChange:(e)=> handleChange(e.target.name,e.target.value.slice(0,50)) }}  maxLength={20}  value={formInputs.surname} required={true} />
              
              <FormElement label={{ for: "name", text: "Prénom" }} input={{className:"width-formInpt_noFlex", type: "text", name: "name", id: "name",required:true,value:formInputs.name, onChange:(e)=> handleChange(e.target.name,e.target.value.slice(0,20)) }}  maxLength={50}  value={formInputs.name} required={true} />
              ...
              <FormElement label={{for:"message",text:"Message"}} textarea={{className:"width-formInpt_noFlex",  name:"message",id:"message",required:true,value:formInputs.message,placeholder:"max 255 characters", onChange:(e)=> handleChange(e.target.name,e.target.value)}} maxLength={255} value={formInputs.message.slice(0,255)} required={true} />
